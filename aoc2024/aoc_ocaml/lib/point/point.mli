(** {1 2‑dimensional points (integer coordinates)}
    ...
    This module offers a compact, ergonomic point type designed to work
    hand‑in‑hand with a {!module:Grid} implementation for Advent‑of‑Code–style
    puzzles and other grid‑based problems.

    Much like the original Rust version, it provides infix operators so you can
