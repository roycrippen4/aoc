...
# 97 "src/loader/ident_env.cppo.ml"
          | Types.Type_abstract _ -> []
          
# 99 "src/loader/ident_env.cppo.ml"
          | Type_record (_, _) -> []
...
# 126 "src/loader/ident_env.cppo.ml"
...
# 166 "src/loader/ident_env.cppo.ml"
let concat_map f l =
...
# 180 "src/loader/ident_env.cppo.ml"
...
# 198 "src/loader/ident_env.cppo.ml"
    | { sig_desc = Tsig_exception { tyexn_constructor; _ }; _ } :: rest ->
       
# 200 "src/loader/ident_env.cppo.ml"
...
# 208 "src/loader/ident_env.cppo.ml"
...
# 226 "src/loader/ident_env.cppo.ml"
...
# 244 "src/loader/ident_env.cppo.ml"
            None
...
# 258 "src/loader/ident_env.cppo.ml"
            None
            
# 260 "src/loader/ident_env.cppo.ml"
            in
...
# 265 "src/loader/ident_env.cppo.ml"
...
# 272 "src/loader/ident_env.cppo.ml"
    | { sig_desc = Tsig_modtypesubst mtd; sig_loc; _ } :: rest ->
      [`ModuleType (mtd.mtd_id, hide_item, Some sig_loc)] @ extract_signature_tree_items hide_item rest
    
# 275 "src/loader/ident_env.cppo.ml"
...
# 284 "src/loader/ident_env.cppo.ml"
  | Tpat_var(id, loc, _) ->
    
# 286 "src/loader/ident_env.cppo.ml"
    [`Value(id, hide_item, Some loc.loc)]
  
# 290 "src/loader/ident_env.cppo.ml"
  | Tpat_alias(pat, id, loc, _) ->
    
# 292 "src/loader/ident_env.cppo.ml"
...
# 298 "src/loader/ident_env.cppo.ml"
  | Tpat_construct(_, _, pats, _)
  
# 300 "src/loader/ident_env.cppo.ml"
  | Tpat_array pats
...
# 316 "src/loader/ident_env.cppo.ml"
    | { str_desc = Tstr_type (_, decls); _ } :: rest -> (* TODO: handle rec_flag *)
  
# 318 "src/loader/ident_env.cppo.ml"
  concat_map (fun decl ->
      `Type (decl.typ_id, hide_item, Some decl.typ_loc) ::
        (match decl.typ_kind with
          Ttype_abstract -> []
...
# 331 "src/loader/ident_env.cppo.ml"
    | { str_desc = Tstr_exception { tyexn_constructor; _ }; _ } :: rest ->
       
# 333 "src/loader/ident_env.cppo.ml"
...
# 342 "src/loader/ident_env.cppo.ml"
    | { str_desc = Tstr_value (_, vbs); _ } :: rest -> (*TODO: handle rec_flag *)
   
# 344 "src/loader/ident_env.cppo.ml"
...
# 364 "src/loader/ident_env.cppo.ml"
...
# 376 "src/loader/ident_env.cppo.ml"
          (fun (cld, _) ->
             
# 378 "src/loader/ident_env.cppo.ml"
             `Class (cld.ci_id_class,
               cld.ci_id_class_type, cld.ci_id_object,
               
# 385 "src/loader/ident_env.cppo.ml"
               None,
              
# 387 "src/loader/ident_env.cppo.ml"
...
# 399 "src/loader/ident_env.cppo.ml"
               None,
              
# 401 "src/loader/ident_env.cppo.ml"
              hide_item, Some clty.ci_id_name.loc
             )) cltyps @ extract_structure_tree_items hide_item rest
    
# 406 "src/loader/ident_env.cppo.ml"
...
# 695 "src/loader/ident_env.cppo.ml"
    | Path.Pdot(p, s) -> `Dot(read_module env p, s)
    
# 699 "src/loader/ident_env.cppo.ml"
    | Path.Papply(p, arg) -> `Apply(read_module env p, read_module env arg)
    
# 701 "src/loader/ident_env.cppo.ml"
    | Path.Pextra_ty _ -> assert false

  
# 704 "src/loader/ident_env.cppo.ml"
  let read_module_type env = function
    | Path.Pident id -> read_module_type_ident env id
    
# 707 "src/loader/ident_env.cppo.ml"
    | Path.Pdot(p, s) -> `Dot(read_module env p, s)
    
# 711 "src/loader/ident_env.cppo.ml"
    | Path.Papply(_, _)-> assert false
    
# 713 "src/loader/ident_env.cppo.ml"
    | Path.Pextra_ty _ -> assert false

  
# 716 "src/loader/ident_env.cppo.ml"
  let read_class_type env = function
    | Path.Pident id -> read_class_type_ident env id
    
# 719 "src/loader/ident_env.cppo.ml"
    | Path.Pdot(p, s) -> `Dot(read_module env p, strip_hash s)
    
# 723 "src/loader/ident_env.cppo.ml"
    | Path.Papply(_, _)-> assert false
    
# 725 "src/loader/ident_env.cppo.ml"
    | Path.Pextra_ty _ -> assert false

    
# 731 "src/loader/ident_env.cppo.ml"
    let rec read_type env = function
    
# 733 "src/loader/ident_env.cppo.ml"
    | Path.Pident id -> read_type_ident env id
    
# 735 "src/loader/ident_env.cppo.ml"
    | Path.Pdot(p, s) -> `Dot(read_module env p, strip_hash s)
    
# 739 "src/loader/ident_env.cppo.ml"
    | Path.Papply(_, _)-> assert false
