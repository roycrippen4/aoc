...
(** @canonical Fix.CompactQueue *)
module CompactQueue = Fix__CompactQueue
...
(** @canonical Fix.DataFlow *)
module DataFlow = Fix__DataFlow

(** @canonical Fix.Enum *)
module Enum = Fix__Enum
...
(** @canonical Fix.Indexing *)
module Indexing = Fix__Indexing

(** @canonical Fix.Memoize *)
module Memoize = Fix__Memoize

(** @canonical Fix.Minimize *)
module Minimize = Fix__Minimize
...
(** @canonical Fix.Partition *)
module Partition = Fix__Partition
