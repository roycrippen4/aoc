...
use aoc2024::{
    day01, day02, day03, day04, day05, day06, day07 as d7,
...
fn main() {
    ...
    total_time += validate(d7::part1::solve, 303766880536, Day::Day06, Kind::Part1);
    total_time += validate(d7::part2::solve, 337041851384440, Day::Day07, Kind::Part2);
