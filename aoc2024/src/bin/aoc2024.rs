...
use aoc2024::{
    day01, day02, day03, day04, day05, day06, day07 as d7, day08, day09,
...
fn main() {
    ...
    total_time += validate(day09::part1::solve, 6448989155953, Day08, Part1);
    total_time += validate(day09::part2::solve, 6476642796832, Day08, Part2);
